...
<style type="text/css">
 .header{  color: white;
  ...
  <div class="main-wrapper">
    ...
    font-family: cursive;">Process Failure Mode and Effects Analysis</h1>
                  ...
                  <div class="content-wrapper">
                    ...
                    <div class="form-wrapper" ng-controller="apqpPFMEACtrl" >
                        ...
                        <div class="input-field col-sm-6">
                          ...
                          <div class="row mg-btm" >
                                    <div class="col-sm-6 input-field">
                                        <label for="lesson">PFMEA Number</label>
                                     <input type="text" class="form-control" name="PFMEANum" id="PFMEANum" ng-model="request.PFMEANum" onkeypress="return Numeric(event);" style=" border-color: grey;" required="true">
                                       
                                       <span ng-cloak class="error-msg " ng-show="(requestForm.PFMEANum.$dirty || invalidSubmitAttempt) && requestForm.PFMEANum.$error.required"> This field is required.</span>
                                    ...
                                    <div class="col-sm-6 input-field">
                                     ...
                                     <input type="text" class="form-control" name="PFMEADate" id="PFMEADate" ng-model="request.PFMEADate" readonly="true" style=" border-color: grey;" required="true" data-date-format="dd/mm/yyyy">
                                       
                                       <span ng-cloak class="error-msg " ng-show="(requestForm.PFMEADate.$dirty || invalidSubmitAttempt) && requestForm.PFMEADate.$error.required"> This field is required.</span>
                ...
                <thead> 
                    ...
                    <tr style="background-color:#4591ba "> 
                        <th class="header" width="25%">Process Step/Function</th>  
                        ...
                        <th class="header" width="15%">Current Process Controls Prevention</th> 
                        <th class="header" width="15%">Occurance</th> 
                        <th class="header" width="15%">Current Process Controls Detection</th> 
                    ...
                    <tr class="data-contact-person table-class-row"> 
                        <td>
                         <textarea class="Clsprocess" name="txtprocess" id="txtprocess1" rows="4"> </textarea>
                        </td>
                      ...
                      <td> <textarea class="Clsfailuremode" name="txtfailuremode" id="txtfailuremode1" rows="4"></textarea></td>
                        ...
                        <td> <input type="text"  class="Clsseverity" name="txtseverity" id="txtseverity1"  onkeypress="return Numeric(event);" style="border-color: grey;"></td>
...
getUser(1);
         ...
         if (processes.trim() == "") {
             ...
             $.simplyToast('Enter process step/function','warning');
             return false;
         }
        if (failuremode.trim()== "") {
         ...
         var rowCount = $('.data-contact-person').length + 1;  
            ...
            if (rowCount > 2) {
              ...
              var processes = ' <textarea class="Clsprocess" name="txtprocess" id="txtprocess'+ rowCount +'" rows="4"></textarea>';
   ...
   function Numeric1(e){
    ...
    $("#btnSave").click(function(e){
      ...
      if(check == true){
        ...
        var targetdate = $("#txttargetDate1").val();
                ...
                if (processes.trim() == "" || processes==undefined) {
                    $.simplyToast('Enter process step/function','warning');
                    return false;
           ...
           $('tr.data-contact-person').each(function () { 
             var processes = $(this).find('.Clsprocess').val();
    ...
    var PFMEANum = $("#PFMEANum").val();
    var PFMEADate = $("#PFMEADate").val();
    ...
    var alldata = {    
        ...
        PFMEAmain.push(alldata); 
        if(f==0){
          $("#btnSave").attr("disabled", true);
            $.ajax({
                   url:base_url+'savePFMEADet',
                    type: 'POST',
                    data:{PFMEAmain:PFMEAmain,PFMEAdet:PFMEAdet},
                     beforeSend: function(){
                    $("#fade").show();
                },
                    success: function (data) {
                      if(data == 1062){
                        $.simplyToast('Duplicate PFMEA Number','warning');
