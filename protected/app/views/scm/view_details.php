                ...
                <div class="col-sm-12">
                    ...
                    <div class="row mg-btm">
                      <div class="col-sm-6">
                        ...
                        <a href="<?php echo Request::root().'/view/download?r_Id=';if(isset($_GET['searchid']))echo $_GET['searchid'];?>">
                                  <button style="margin-top: -80px;margin-left: 150px;" class="btn btn-animate flat blue pd-btn  view_btn" type="submit">PDF Download</button></a>
                                  <?php }?>
                                  </div>
                        </div><!--/page-heading-->
                      </div>
                        ...
                        <?php if(!isset($_GET['link']) ) {?>
                           <form method="get" role="form" action="" class="col-sm-12 myform" ng-class="{'submitted': submitted}" name="requestForm" novalidate ng-submit="(submitted = true) && requestForm.$invalid && $event.preventDefault()" autocomplete="off">
                              ...
                              <div class="inline-form pull-right col-sm-6">
                               ...
                               <div class="col-sm-8">
                                    <select class="form-control" select2=""  ng-model="request.searchid" name="searchid"  id="searchid" required  style="margin-left: 100px;">
                                          <option  value=""></option>

                                          <option ng-repeat="r in getChangeRequest" value="<%r.request_id%>"><%r.request_id%></option>
                                ...
                                <div class="btn-wrap">
                                  ...
                                  <button style="margin-top: -3px;" class="btn btn-animate flat blue pd-btn  view_btn" ng-click="dosearch(requestForm,search)" type="submit">View</button>
                                </div>
                                </div>
                              </div>
                            </form>
                  ...
                  <div class="content-wrapper" ng-cloak="" ng-show="showReport" ng-init="summeryReport('<?php if(isset($_GET['searchid']))echo $_GET['searchid']; ?>')">
                    ...
                    <div class="row mg-bottom-0">
                      <div class="col-sm-12">
                        ...
                        <section class="report-wrapper" ng-if="summeries.result!=1">
                                ...
                                <tr>
                                  ...
                                  <td> <ul ng-repeat="member in summeries.get_change_request_attachment" >
                                         ...
                                         <li ng-if="member.attachment_file!=''">
                                           <span ng-bind="member.attachment_file"></span>  <div ng-if="summeries.checkfiledowncond != 0"><a href="<?php echo Request::root().'/download?path=changeRequest&filename='?><%member.attachment_file%>" data-position="bottom" data-delay="50" data-tooltip="Download" ><i class="glyphicon glyphicon-download-alt"></i></a></div>
                                              <a style="color: #34B0E6;" target="blank" href="<?php echo 'uploads/changeRequest/';?><%member.attachment_file%>"><i class="fa fa-eye"></i></a>
                                         </li>
                                       </ul></td>
                                </tr>
                          ...
                          <div  >
                             ...
                             <uib-accordion close-others="oneAtATime" ng-repeat="risk in risksdatas1" ng-if="risk.riskdata.length!=''">
                              ...
                              <uib-accordion-group is-open="status.open">
                               ...
                               <span ng-bind="risk.sub_dep_name" id="tab_<%risk.count%>"> <i class="pull-right glyphicon" ng-class="{'glyphicon-triangle-top': status.open, 'glyphicon-triangle-bottom': !status.open}"></i></span>
                                </uib-accordion-heading>
                                      ...
                                      <td class="no-pd">
                                        <table>
                                          <tr ng-repeat="attchment in list.attachments">
                                            ...
                                            <td><%attchment.attachment_file%> <div ng-if="summeries.checkfiledowncond != 0"><a href="<?php echo Request::root().'/download?path=attachments&filename='?><%attchment.attachment_file%>" data-position="bottom" data-delay="50" data-tooltip="Download"><i class="glyphicon glyphicon-download-alt"></i></a></div>
                                              <a style="color: #34B0E6;" target="blank" href="<?php echo 'uploads/attachments/';?><%attchment.attachment_file%>"><i class="fa fa-eye"></i></a>
                                            </td>
                                                      ...
                                                      <td class="no-pd">
                                                        <table>
                                                          ...
                                                          <tr ng-repeat="attchment in customer.customer_approval_attachment_status.attachments">
                                                            <td><%attchment.doc_name%> <div ng-if="summeries.checkfiledowncond != 0"><a href="<?php echo Request::root().'/download?path=attachments&filename='?><%attchment.doc_name%>" data-position="bottom" data-delay="50" data-tooltip="Download"><i class="glyphicon glyphicon-download-alt"></i></a></div>
                                                             <a style="color: #34B0E6;" target="blank" href="<?php echo 'uploads/attachments/';?><%attchment.doc_name%>"><i class="fa fa-eye"></i></a></td>
                            ...
                            <table class="striped mg-bottom-20">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td >
                                    <ul ng-repeat="member in summeries.before_after_attachement" >
                                      ...
                                      <li ng-if="member.attachment_file!=''">
                                        <span ng-bind="member.attachment_file"></span>  <div ng-if="summeries.checkfiledowncond != 0"><a href="<?php echo Request::root().'/download?path=before_after_status_option_attachment&filename='?><%member.attachment_file%>" data-position="bottom" data-delay="50" data-tooltip="Download"><i class="glyphicon glyphicon-download-alt"></i></a></div>
                                        <a style="color: #34B0E6;" target="blank" href="<?php echo 'uploads/before_after_status_option_attachment/';?><%member.attachment_file%>"><i class="fa fa-eye"></i></a></td>
                                  ...
                                  <td width="25%">
                                    <%summeries.ptrapplicable%>
                                      ...
                                      <li ng-if="member.attachment_file!=''">
                                        <span ng-bind="member.attachment_file"></span> <div ng-if="summeries.checkfiledowncond != 0"> <a href="<?php echo Request::root().'/download?path=PTRDocument&filename='?><%member.attachment_file%>" data-position="bottom" data-delay="50" data-tooltip="Download"><i class="glyphicon glyphicon-download-alt"></i></a></div>
                                         <a style="color: #34B0E6;" target="blank" href="<?php echo 'uploads/PTRDocument/';?><%member.attachment_file%>"><i class="fa fa-eye"></i></a>
                                ...
                                <tr>
                                    ...
                                    <table class="borderd-cell">
                                      <td width="25%" class="pd-none">
                                        <table class="borderd-cell">
                                          ...
                                          <tr>
                                            <td width="50%" class="border-bottom" ng-if="summeries.final_closer.status==26"><%summeries.final_closer.status|Closerfiler%></td>
                                  ...
                                  <td width="25%" class="pd-none" ng-if="summeries.final_closer.status==20 || summeries.final_closer.status==21 || summeries.final_closer.status==22 || summeries.final_closer.status==25  ">
