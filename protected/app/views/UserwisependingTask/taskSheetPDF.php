                ...
                <table style="font-size:10px;border-spacing:0;width:100%;max-width:100%;overflow-x:auto!important;table-layout:fixed;border-bottom:1px solid #e5e5e5;">
                    ...
                    <tr>
                        ...
                        <th width="12%" style="color:#38393A;border:1px solid #E5E5E5;border-right:none;font-weight:600;padding:10px;text-align:left;vertical-align: bottom;display:table-cell;padding: 15px 5px;"><strong><span>Initiator Name<span></strong></th>
                         <th width="12%" style="color:#38393A;border:1px solid #E5E5E5;border-right:none;font-weight:600;padding:10px;text-align:left;vertical-align: bottom;display:table-cell;padding: 15px 5px;"><strong><span>Part Name<span></strong></th>
                         <th width="12%" style="color:#38393A;border:1px solid #E5E5E5;border-right:none;font-weight:600;padding:10px;text-align:left;vertical-align: bottom;display:table-cell;padding: 15px 5px;"><strong><span>Part Number<span></strong></th>

                         <th width="12%" style="color:#38393A;border:1px solid #E5E5E5;border-right:none;font-weight:600;padding:10px;text-align:left;vertical-align: bottom;display:table-cell;padding: 15px 5px;"><strong><span>Modification Details<span></strong></th>
                    ...
                    <tbody>
                      <?php if(sizeof($data)>0){
                        ...
                        foreach($data as $sheet){
                         ...
                         <td width="12%" style="padding-left:5px;border-style:solid;border-width:0px 0px 0px 1px;border-color:#E5E5E5;"><ul >
                         ...
                         <td width="12%" style="padding-left:5px;border-style:solid;border-width:0px 0px 0px 1px;border-color:#E5E5E5;">
                            <ul >
                                <?php foreach($sheet['part'] as $partname ){ ?>
                         ...
                         <td width="12%" style="padding-left:5px;border-style:solid;border-width:0px 0px 0px 1px;border-color:#E5E5E5;"><?php echo $sheet['modDtls'];?></td>
                         <td colspan="5" width="65%">
                           <table width="100%">
                            <?php
                              ...
                              ?>
                             <tr>
                               <td width="15%" style="padding-left:5px;border-style:solid;border-width:0px 0px 0px 1px;border-color:#E5E5E5;"><span><?=$value['assignedto'];?><?php echo ' ('.$value['department'].')';?></span></td>
