...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="col-md-8">
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('pdfWeekly/') }}{{'/'.$project_details->id;}}">PDF Download</a>
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('excelWeekly/') }}{{'/'.$project_details->id;}}">Excel Download</a>
              ...
              <?php 
                ...
                $pgate = '';
                 foreach($activities as $z=>$row){
                  ...
                  if($ngate != $pgate){
                     ?>
                    <tr style="height: 71px" class="left-table-bdr-top"><td  colspan=" " style="font-weight:bold;"><?php echo 'Phase '.$row->gate_id.' '.$row->Gate_Description;?></td></tr>
                    <?php }
                    $pgate = $ngate;
                  if($z != 0)
                  {
                    ...
                    <td>
                      <table class="left-sub-table">
                          <tr>
                            ...
                            <tr class="bdr-only-top" >
                              <td><?php echo $row->actual_duaration;
                                       ?></td>
                            </tr>
                        </table>
                    </td>
          ...
          <table class="table bdr-right right-table"> 
            <thead>              
                <tr>
                    ...
                    <th><?php echo date('d',strtotime($project_all_dates[$i])); 
             ...
             <?php 
              ...
              foreach($activities as $z=>$row){
                ...
                <tr>
                    ...
                    // echo '<pre>';print_r($activity_row);exit();
                    for($i = 0;$i<count($activity_row);$i++){ 
                      // echo "<pre>"; print_r($activity_row[$i]);exit();?>
                    
                    
                    <td>
                      <table class="left-sub-table bdr-left ">
                        <?php for($j =0;$j<count($activity_row[$i]);$j++){
                          // echo "<pre>"; print_r($row->plan_end_date);print_r($row->actual_end_date); exit();?>
