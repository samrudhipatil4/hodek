                ...
                <table class="striped" border="1">
                    ...
                    <th width="200">Document
                    	...
                    	<th width="50" style="text-align: center;">SR.NO</td>
							 		...
							 		<th width="225" style="text-align: center;">Remark</th>
							 		<th width="225" style="text-align: center;">Updated date</th>
							 		<th width="225" style="text-align: center;">Issue</th>
							 		<th width="225" style="text-align: center;">Issue Document</th>
                    </tr>
                    		</table>
                    </th>
                   		...
                   		$i1=1;	$j=1;
								...
								$pgate = $ngate;
							 	...
							 	<tr>
									...
									<td>
									<table><?php $i=1;if(!empty($value['document'])) { 
							 			   foreach($value['document'] as $row){  
							 				if($row['id'] == $value['d_id']){ ?>
												<tr><td style="width:30" style="border-left: 1px solid #dddddd;border-right: 1px solid  #dddddd;"><?php echo $i;?></td>
...
<tr>
							 		...
							 		<td><?php echo $value['remark'];?></td>
							 		<td><table><tr>
							 		<td width="50" style="border-left: 1px solid #dddddd;border-right: 1px solid  #dddddd;">SR.NO</td>
							 		<td width="225" style="border-left: 1px solid #dddddd;border-right: 1px solid  #dddddd;">Parameter</td>
							 		<td width="225" style="border-left: 1px solid #dddddd;border-right: 1px solid  #dddddd;">Document</td>
