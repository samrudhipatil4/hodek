                            ...
                            <table class="striped mg-bottom-20">
                              <tbody>
                                <tr>
                                  ...
                                  <td width="25%">Responsibility to get Customer Approval</td>
                                    ...
                                    <table>
                                      ...
                                      <tr>
                                           <td><strong><?php echo $member['name'][0]['name']; ?></strong></td>
                                            ...
                                            <td >
                                            <?php echo $member['approval_status']; ?>
                                            </td>
                                            <?php }?>                                                                             
                                      </tr>
                                      <?php }?>
                                    ...
                                    <table class="borderd-cell">
                                      <tr>
                                        ...
                                        <td width="50%">
                                           ...
                                           <?php echo $summeries['responsibility_to_get_customer_approval']->first_name." ".$summeries['responsibility_to_get_customer_approval']->last_name; ?>
                                        </td>
                                      </tr>
                                    </table>
                                  </td>
                                                ...
                                                <div class="table-wrapper">
                                                  <table class="striped table-border">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td class="no-pd">
                                                        <table>
                                                           <?php foreach ($customer['attachments'] as $attchment) {?>
                                                          <tr>
                                                            <td>
