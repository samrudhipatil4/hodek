...
<?php require app_path().'/views/apqp_header.php'; ?>
  ...
  <div class="main-wrapper">
    <div class="container" ng-controller="CostController">
                  ...
                  <div class="content-wrapper">
                    ...
                    <div class="form-wrapper" >
                        <div class="row mg-bottom-0">
                           ...
                           <form method="post"  role="form" action="<?php echo Request::root().'/getReviewReport'; ?>" class="col-sm-12 myform" ng-class="{'submitted': submitted}" name="requestForm" novalidate ng-submit="(submitted = true) && requestForm.$invalid && $event.preventDefault()" autocomplete="off">
