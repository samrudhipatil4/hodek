              ...
              <tr>
                <td style=" padding: 20px 20px 0px;background-color: #FAFAFA;">
                  <table cellpadding="0" cellspacing="0" width="100%" style="margin: 20px 0;">
                    ...
                    <tr>
                      <td style="padding-bottom:10px">{{$task_assigned_to}}</td>
                    </tr>
                    <tr>
                      <td><strong>Request No. :</strong></td>
                   
                      <td style="padding-bottom:10px">{{$request_id}}</td>
                    </tr>
                    <tr>
                 ...
                 <!--  <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      ...
                      <td style=" padding: 20px 0;background-color: #FAFAFA;">
                        <a href="{{ URL::to($url) }}/{{ $request_id }}/{{ $Close_status }}" target="_blank">{{ URL::to($url) }}/{{ $request_id }}/{{ $Close_status }}</a>
                      </td>
                    </tr>                    
                  </table> -->
                </td>
