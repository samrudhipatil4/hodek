...
<br>
    <tr>
        <td width="400"><strong>You have new task for Project Revision:</strong></td>
        <td width="400">Remark :<?php echo $remark; ?></td>
    </tr>
    <br>
     <tr>
        <td width="400">Remark :<?php echo $remark; ?></td>
    ...
    <tr>
        <td width="200">Project Number :</td>
         <td width="600" style="margin-top: 5px"><?php echo $proj_id.'-'.$revision; ?></td>
    </tr>
