...
<?php require app_path().'/views/apqp_header.php'; ?>
  ...
  <div class="main-wrapper">
    ...
    font-family: cursive;"> Material Activity Gantt Chart </h1>
                  ...
                  <div class="content-wrapper">
                    ...
                    <div class="form-wrapper" >
                        <div class="row mg-bottom-0">
                           ...
                           <form method="post"  role="form" action="<?php echo Request::root().'/gnatt-chartMaterial'; ?>" class="col-sm-12 myform" ng-class="{'submitted': submitted}" name="requestForm" novalidate ng-submit="(submitted = true) && requestForm.$invalid && $event.preventDefault()" autocomplete="off">
                            <div class="row mg-btm">
                              ...
                              <div> <input type="radio" name="filter" value="daily" id="daily" checked><label for="daily">Daily</label>
                              </div>

                              <div> <input type="radio" name="filter" value="weekly" id="weekly"><label for="weekly">Weekly</label>
                              </div>

                               <div> <input type="radio" name="filter" value="monthly" id="monthly"><label for="monthly">Monthly</label></div>
                                </div>
