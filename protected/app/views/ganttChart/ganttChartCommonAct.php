...
<?php require app_path().'/views/apqp_header.php'; ?>
  ...
  <div class="main-wrapper">
    ...
    font-family: cursive;"> Common Activity Gantt Chart </h1>
                  ...
                  <div class="content-wrapper">
                    ...
                    <div class="form-wrapper" >
                        <div class="row mg-bottom-0">
                           ...
                           <form method="post"  role="form" action="<?php echo Request::root().'/gnatt-chartCommon'; ?>" class="col-sm-12 myform" ng-class="{'submitted': submitted}" name="requestForm" novalidate ng-submit="(submitted = true) && requestForm.$invalid && $event.preventDefault()" autocomplete="off">
