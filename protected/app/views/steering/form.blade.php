					...
					<fieldset><legend> Steering User</legend>
						...
						<div class="form-group  " >
							...
							<div class="col-md-6">
								...
								{{ Form::hidden('group_id', '5,12',array('class'=>'form-control', 'placeholder'=>''  )) }}
						 ...
						 <div class="form-group  " >
									<label for="department" class=" control-label col-md-4 text-left"> Sub function <span class="asterix"> * </span></label>
									<div class="col-md-6">
...
?>
	...
	{<?php
		...
		cache:false,
		//data: { dep_id: value },
		url:base_url+'steering/subdepartment_ajax/<?=$id;?>',
