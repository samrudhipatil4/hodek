...
<caption style="font-size: 20px"><strong>Change Request Details</strong></caption>
    ...
    <tr>
        <td width="25%"><strong>Project Code</strong></td>
                                 ...
                                 <td width="25%">
                                   <ul class="listing">
                                    <?php if(!empty($summeries['parts'])){foreach($summeries['parts'] as $part){?>
     ...
     <td width="25%"><strong>Approval Response Date</strong></td>
                 ...
                 <tr>
                                <td  >
                                  ...
                                  <strong>Function</strong></td>
                                    ...
                                    <?php if(!empty($summeries['team_members'])){foreach($summeries['team_members'] as $team){ ?>
                ...
                Change implementation date of new index level</strong></td>
                                                <td><strong>Initiation Date</strong></td>
                                                 ...
                                                 <td><?php echo $summeries['teamleader']['stock'];?></td>
                </tr> 
                <tr>
                <td colspan="2">
                    <table border="1" width="100%"><tr>
                      <td width="30"><strong>Project Manager</strong></td>
                      <td width="70"><?php echo $summeries['projrct_mgr'];?></td>
                    </tr></table>
                  </td>
                  <td colspan="3">
                    <table border="1" width="100%"><tr>
                      <td width="70"><strong>Cost Impact & Investment Details</strong></td>
                      <td width="30"><?php echo $summeries['totalcost'];?></td>
                    </tr></table>
                  </td>
                </tr>
...
<tr><td>
    <?php if(!empty($summeries['risksdatas1'])) {  foreach($summeries['risksdatas1'] as $risk){ ?>
                               ...
                               <?php  if(!empty($risk['riskdataformail'])) { 
                                            ?>
                                <span align="central" style="font-size: 20px;display:inline-block;margin-bottom: 10px;margin-top: 20px"> <strong><?php echo $risk['sub_dep_name'];?></strong></span>            
                               <table border="1" width="100%">
                                <tr>
                                ...
                                <?php } ?>
                                  <table border="1" width="100%">
                                    ...
                                    <?php  $i=0;
                                        foreach($risk['riskdataformail'] as $point) { 
                                            ?>
                                    <tr>
                                      ...
                                      <td width="10%"><?php if(!empty($point['hod_approval'])){ if($point['hod_approval']->status == 1){echo 'YES';}else{echo 'NO';} }?></td>
