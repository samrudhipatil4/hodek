                    ...
                    <div class="form-wrapper">
                          ...
                          <div class="row mg-top">
                              <div class="col-sm-12 ">
                                ...
                                <a class="btn btn-animate flat blue pd-btn pull-right" href="<?php echo Request::root().'/changes/approval-risk-assesment-based-on-cost/'.Request::segment(3); ?>/<?=Request::segment(4); ?>">Next</a>
                              </div>
                          </div>
