...
<br>
    <tr>
        <td width="700">Following tasks are pending for your action:</td>
        <td width="100"></td>
    </tr>
   <br>
     <?php  $i=1;
        ...
        <td width="100"  >Project Number  :</td>
         <td width="700" style="margin-top: 5px"><?php echo $row['proj_id'].' Revision '.$row['revision']; ?></td>
    </tr>
     <tr>
        <td width="100"  >Project Name  :</td>
         <td width="700" style="margin-top: 5px"><?php echo $row['proj_name']; ?></td>
    </tr>
    <tr>
        <td width="100"  >Gate Name :</td>
         <td width="700" style="margin-top: 5px"><?php echo $row['gate_id']; ?></td>
    </tr>
     
    <tr>
    <td width="100">activity :</td>
    <td width="700" style="margin-top: 5px"><?php echo $row['activity'];?>
    </tr>
    
    
     <tr>
    <td width="100">Activity Start Date :</td>
    <td width="700" style="margin-top: 5px"><?php echo $row['startdate'];?>
    </tr>
     
    <tr>
    <td width="100">Activity End Date :</td>
    <td width="700" style="margin-top: 5px;border-width:1px" ><?php echo $row['end_date'];?></td>
    </tr>
