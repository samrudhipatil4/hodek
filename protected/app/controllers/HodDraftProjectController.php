<?php
class HodDraftProjectController extends BaseController {
	...
	public function __construct() {
		...
		$this->data = array(
			...
			'pageModule'=> 'hodDraftProjectPlan',
	...
	public function saveProject(){
		...
		if(!empty($prjAvl)){
			echo '<table style="display:none" align="center" border="1" width="100%" id="project_plan">
							<tr>
								<td>SR.NO.</td>
