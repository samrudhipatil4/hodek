                          ...
                          <form class="col-sm-12">
                            ...
                            <div class="row mg-bottom-0">
                             ...
                             <div class="row mg-bottom-0">
                                <div class="col-sm-6">
                                    <p>
                                        <input class="with-gap"  type="radio" id="closed" name="radioStatus" ng-model="closer.radioStatus" value="26"  />

                                        <label for="closed">Reject</label>  
                                    </p>
                                   
                                </div>                             
                            </div>
                            <div class="row mg-bottom-0" ng-if="closer.radioStatus=='26'">
                                <div class="col-sm-6">
                                    <p>
                                       <label for="textarea">Comment</label>
                                <textarea id="textarea" name="rejectcoment" ng-model="closer.rejectcoment" class="materialize-textarea" required></textarea>
                                <span ng-cloak class="error-msg " ng-show="(cmCloserForm.rejectcoment.$dirty || invalidSubmitAttempt) && cmCloserForm.rejectcoment.$error.required"> This field is required.</span> 
                                    </p>
                            ...
                            <div class="row mg-btm" ng-if="stage!='1'">
                             ...
                             <div class="row" ng-if="stage=='1' && closer.radioStatus!='25' && closer.radioStatus!='26'">
