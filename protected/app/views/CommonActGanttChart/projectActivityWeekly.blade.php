...
<div class="row">
    ...
    font-family: cursive;">Common Activity Gantt Chart</h1>
         ...
         <div class="col-sm-4">
            <div class="page-heading pull-right">
                <a class="btn btn-animate flat blue pd-btn" href="<?php echo Request::root().'/ganttChartCommonAct'; ?>">Back To Search</a>
            </div><!--/page-heading-->
  ...
  <div class="col-md-12">
    <div class="col-md-8">
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('commonpdfWeekly/') }}{{'/'.$project_details->id;}}">PDF Download</a>
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('commonexcelWeekly/') }}{{'/'.$project_details->id;}}">Excel Download</a>
