<?php
class commodityMasterController extends BaseController {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'CommodityMaster';
	static $per_page	= '10';
	
	public function __construct() {
		parent::__construct();
		$this->beforeFilter('csrf', array('on'=>'post'));
		$this->model = new CommodityMaster();
	...
	public function getIndex()
	{
		...
		$this->layout->nest('content','commodityMaster.index',$this->data)
	...
	function getAdd( $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('apqp_commodity_master'); 
		}
		...
		$this->layout->nest('content','commodityMaster.form',$this->data)->with('menus', $this->menus );	
	}
