                  ...
                  <div class="content-wrapper">
                    ...
                    <div class="form-wrapper" >
                        <div class="row mg-bottom-0">
                           ...
                           <form method="post"  role="form" action="<?php echo Request::root().'/getCriticalPathReport'; ?>" class="col-sm-12 myform" ng-class="{'submitted': submitted}" name="requestForm" novalidate ng-submit="(submitted = true) && requestForm.$invalid && $event.preventDefault()" autocomplete="off">
                             <div class="row mg-btm">
                                <div class="input-field col-sm-6">
                              <label for="initiator_name">Select Project</label>
                              <select class="form-control" select2=""  ng-model="request.proj_no" name="proj_no" ng-change="checkPrjApply(request.business)" required>
                                  <option  value=""></option>
                                  <option ng-repeat="d in file" value="<%d.project_id%>"><%d.project_no%></option>
                              </select>
