...
class ChangerequestController extends BaseController
{
    ...
    public function get_chart3()
    {
        ...
        $users = DB::table('changerequest_purpose')
           ...
           Below comment code is for department
        ...
        foreach ($users as $value) {
            ...
            $data['val'][] =
                ...
                $data['val'][] =
                $this->get_chart3_result($value->d_id);
    ...
    public function addDeptAndUser($r_id,$dept_id,$user_id){
      ...
      DB::table('tb_updatesheet_dep_team')->insert(
              ...
              // ->where('project_code',$p_code[0]->project_code)
              // ->where('d_id',$dept_id)
              // ->update(
              //     array('flag' => 1,
              //       'user_id' => $user_id 
   ...
   $add= DB::table('add_updated_risk_assessment_sheet')->insert(
    ...
    public function change_stage()
    {
        ...
        $data = DB::table('tb_change_stage')->select('change_stage_id', 'stage_name')->get();
        ...
        if (Request::isJson()) {
         ...
         if(!empty($input->uploadFileName)){
            ...
            if ($input->type == 1) {
                ...
                $data_1 = array('firstname'=>$contactName,'description'=>$message,'assigned_task_by'=>$assignedby,'task_assigned_to'=>$assignedto,'url'=>$url,'request_id'=>$request_id,'Close_status'=>$close_status);
...
//         return $data;
    ...
    public function stakeholder()
    {
        ...
        //Returns All plantcodes
        $stakeholder = DB::table('tb_stakeholder')->select('id', 'description','name')->get();
    ...
    public function purposechange()
    {
        ...
        //Returns All plantcodes
        $purposechange = DB::table('changerequest_purpose')->select('id', 'changerequest_purpose')->get();
...
// print_r($init_id);exit();
    ...
    public function count_applicability($request_id){
      ...
      //  print_r($user2);exit;
        ...
        if($user1[0]->total==$user2[0]->total || $user1[0]->total>$user2[0]->total){
        ...
        if (Request::isJson()) {
          ...
          //----start code for tracking Sheet----
            ...
            $data_11 = DB::table('tb_users')
                ...
                ->select('tb_updatesheet_dep_team.team_member', 'tb_users.email','tb_users.department')->where('tb_updatesheet_dep_team.request_id', $input->request_id)->get();
            ...
            foreach ($data_11 as $value) {
                ...
                $initiator_id = $this->get_hod_by_user_department($dep);
             ...
             $StageType = DB::table('changerequests')
                    ...
                    if($StageType[0]->change_stage == 2 && $StageType[0]->proj_code != "" ){
                      ...
                      $prj_mgr = DB::table('tb_projectMaster')
                                ...
                                $data_1 = array('firstname'=>$contactName,'description'=>$message,'allTeam'=>$data2,'cr'=>$cmNo);
     ...
     public function add_update_risk_analysis($request_id, $id, $user_id,$risk_ass_id,$dept_id)
    {
      ...
      if($StageType[0]->change_stage == 1){
        ...
        $data3 = DB::table('request_progress_status')
            ...
            $data_1 = array('firstname'=>$contactName,'description'=>$message,'assigned_task_by'=>$assignedby,'url'=>$url,'request_id'=>$request_id,'Close_status'=>$close_status);
            if($this->check_netconnection())
            {
    ...
    public function add_pending_approval($id, $id1)
    {
        ...
        //---------------------------------
            ...
            if ($data2[0]->total > 1) { //echo "in 
                ...
                $data_1 = array('firstname'=>$contactName,'description'=>$message,'assigned_task_by'=>$assignedby,'url'=>$url,'request_id'=>$request_id,'Close_status'=>$close_status,'comment'=>$comment);
  ...
  // End of CFT team Representative User
    ...
    public function get_hod_approval($request_id,$user_id){
          ...
          return $users = DB::table('approval_risk_assessment')
            //  ->leftJoin('add_updated_risk_assessment_sheet', 'approval_risk_assessment.user_id', '=', 'add_updated_risk_assessment_sheet.hod')
             ...
             // ->groupBy('approval_risk_assessment.user_id')
              ->first();
        ...
        if (!empty(Input::get('delete_attachment'))) {
            ...
            if (Input::hasFile('doc')) {
                ...
                foreach ($names as $name) {
                    ...
                    $upload_success = $name->move($destinationPath, $filename);
                    $list_id = Input::get('list_id');
                    $comment = Input::get('comment');

                    $this->save_attachment_files($id, $filename, $list_id,$comment);
     ...
     * @return mixed
     */
    public function submit_customer_communication_list($id)
    {
        $input = (object)Input::all();         
  ...
  return $total[0]->total;
    ...
    public function reject_risk_assessment_based_oncost($id, $id1)
    {
        ...
        foreach ($aa as $ans) {
            ...
            $data_1 = array('firstname'=>$contactName,'description'=>$message,'assigned_task_by'=>$assignedby);
    ...
    public function customer_verify($id1)
    {
        ...
        if ($input->radioStatus == 1) {
            ...
            ->first();
              ...
              /*  Mail::send('emails/email-template', array('data' => (String)$value->email), function ($message) use ($email_id) {
         ...
         /*   $data1  = DB::table('request_progress_status_temp')
                ->select('request_progress_status_temp.assigned_by')
                ->where('request_id', $input->request_id)
            ...
            foreach ($data1 as $value) {
                ...
                $id = (String)$value->assigned_by;


                $users_detail = $this->get_user_info_by_id($id);

                $message = "Pending from Responsible person to monitor activity completion status.";

                $url = 'changes/activity-monitoring/';
                $this->save_noticication_status($id, $input->request_id, $message, $url, 14);
            ...
            /*
             *
             * Below is old code working new code as per client new changes is above
             *
             */
         ...
         /*   DB::table('customer_verification')->insert(
            ...
            $id = (String)$data1->assigned_by;


            $message = "Pending from Responsible person to moniter activity completion status.";
        ...
        if (!empty(Input::get('delete_attachment'))) {
            ...
            if (Input::hasFile('doc')) {
               ...
               if (!in_array(strtolower($ext), $a)) {
                    ...
                    $this->save_attachment_files_activity_monitering($id, $filename, $risk_assessment_id,$applicability,$user_id,$dep_id);


                    /*     DB::table('activity_monitering_document_attachment')->insert(
                    array('request_id' => $id,
                        'document_category_file' => $imagename,
                        'list_id' => Input::get('risk_assessment_id'),
                       // 'document_category_id' => Input::get('risk_assessment_document_id'),
                        // 'user_id' => $input->user_id,
                        // 'created_date' => date('Y-m-d H:i:s'),
                    )
   ...
   public function PTR_document($id)
    {
        ...
        //if($this->check_permission(6)&& $this->check_request_permission($id)){
    ...
    public function verify_activity_completion_sheet($id, $id1)
    {
        ...
        if ($input->radioStatus == 1) {
           ...
           $request_id=$id;
            ...
            /*
             *
             * Again changes done for comment
             *
             */
          ...
          /*  DB::table('activity_completion_sheet_verify')->insert(
            ...
            $data1  = DB::table('request_progress_status')
                ->select('request_progress_status.assigned_to')
                ->where('request_id', $id)
                ->where('assigned_by',Session::get('uid'))
                ->where('close', 1)
                ->where('status',14)
                ->where('next_url','=','changes/activity-monitoring/')
                ->orderBy('request_progress_status.created_date','desc')
                ->get();
            ...
            foreach ($data1 as $value) {
                ...
                $user_id = (String)$value->assigned_to;
                ...
                $url = 'changes/activity-monitoring/';
                $this->save_noticication_status($user_id, $id, $message, $url, 14);
            ...
            /*
             *
             * Old code below new code above changes effects as per new client changes done in flow
             *
             */
         ...
         /*   $data1  = DB::table('request_progress_status')
            ...
            $user_id = (String)$data1->assigned_by;
           // print_r($id);exit;
    ...
    public function horizontal_deployment_approval($id, $id1)
    {
        ...
        if ($input->radioStatus == 1) {
            ...
            if ($data1[0]->total > 0) {
                ...
                $message = "Pending decision on Implementation Date & before-after status.";
        ...
        if (Input::hasFile('doc')) {
         ...
         $users = DB::table('tb_users')
          ...
          $CM_dtls=DB::table('changerequests')
                    ->leftJoin('tbl_change_type', 'changerequests.changeType', '=', 'tbl_change_type.change_type_id')
                    ->select('change_type_name','created_date','status','change_stage')
                    ->where('request_id',$r_id)
                    ->get();
         ...
         $CMNo=$this->generate_cm_no($CM_dtls[0]->change_type_name, $CM_dtls[0]->created_date, $r_id, $CM_dtls[0]->status);
                  ...
                  $filename2 = Config::get('app.site_root').'uploads/PTRDocument/'.$filename;
          ...
          //  print_r($files);exit;
            ...
            foreach ($files as $file) {
               ...
               if (!in_array(strtolower($ext), $a)) {
                ...
                $this->save_before_after_status_attachments($filename,$date,$id);
            }
        }else{
            $filename='';
            $this->save_before_after_status_attachments($filename,$date,$id);
