...
//$("#fade").show();
    ...
    $scope.EditRecord = function(index,id,dept_id,r_id) {
...
//
                ...
                $scope.fetch = function(id,$initiator){
                    ...
                    $http
                        ...
                        $scope.removeDept = function(r_id,dept_id){
...
masterApp.controller('CtrlRiskAnalysis1', function($scope,$http){
    ...
    $scope.get_info=function(id,risAssId){
...
masterApp.controller('CtrlRiskAnalysis', function($scope,$http){
 ...
 $scope.DelRecord = function(index,id) {
   ...
   //====================================================================================
 $scope.isDisabled = false; 
 $scope.EditRecord = function(index,id,risk_ass_id,dept_id,r_id) {
...
$scope.reset=function(){
 ...
 $scope.addRequest = function(requestForm,type,customer_id,customer_id1,change_type,file,file) {
    ...
    $scope.deploy = {
        ...
        $http
           ...
           $scope.fetch_dep_for_approval_assessment_on_cost=function(id,user_id){
                    ...
                    $http
                .get(appurl + 'changes/checkPrvOfCustComDecision')
                .success(function(data, status, headers, config) {
...
$scope.isDisabled=false;
  $scope.addapproval_assessment_based_ONCOST=function(approval_based_costForm,approval,r_id,id){
            ...
            var deply = $scope.deploy.horizDeploy;
            var cuComm = $scope.communi.custComm;
                 $http
                            .post(appurl + 'changes/checkCustComm/'+r_id+'/'+cuComm+'/'+deply)
                            .success(function(data, status, headers, config) {
                             
                            if(data.trim() == "1" || data.trim() == "2"){
                               
                                $.simplyToast('select members', 'warning');
                    ...
                    $http
                            .post(appurl + 'changes/addapproval_assessment_based_oncost/'+r_id+'/'+deply+'/'+cuComm+'/'+id, data)
                            .success(function(data, status, headers, config) {
                              $scope.isDisabled = true;
                               alert(data);
                                location.href = appurl + 'dashboard';
        ...
        $scope.deleteRecord=function(id,r_id,file){
            ...
            $http
                ...
                if(data != ""){
                    ...
                    //redirect('changeRequestModifyDetails',r_id)
