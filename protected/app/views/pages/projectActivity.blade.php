...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="col-md-8">
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('pdf/') }}{{'/'.$project_details->id;}}">PDF Download</a>
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('excel/') }}{{'/'.$project_details->id;}}">Excel Download</a>
            ...
            <thead>              
              ...
              <?php if($row->material_id == 0){?>        
                <tr class="left-table-bdr-top">
                    ...
                    <td>
                        <?php foreach($responsibility as $key=>$user){ 
