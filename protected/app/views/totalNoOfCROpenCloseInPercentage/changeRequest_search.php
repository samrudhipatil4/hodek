...
<?php require app_path().'/views/header.php'; ?>
  ...
  <div class="main-wrapper">
    <div class="container" ng-controller="totalNoOfCRInPercentageCtrl">
                  ...
                  <div class="content-wrapper">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="page-heading mg-btm">
                          <h2>To View % of open & closed change requests, Please Fill up following Data</h2>
                        </div><!--/page-heading-->    
                      </div>
                    </div>
                    ...
                    <div class="form-wrapper" >
                        <div class="row mg-bottom-0">
                           ...
                           <form method="post"  role="form" action="<?php echo Request::root().'/totalCRInPercentage-search-result'; ?>" class="col-sm-12 myform" ng-class="{'submitted': submitted}" name="requestForm" novalidate ng-submit="(submitted = true) && requestForm.$invalid && $event.preventDefault()" autocomplete="off">
