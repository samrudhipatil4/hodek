...
class shiftTaskController extends ChangerequestController
{
   ...
   public function shift_department()
    ...
    public function steerCommSubFunction()
    {

        //Returns sub departments 
        $subDept = DB::table('subdepartments')->select('sub_dep_id', 'sub_dep_name')->where('department_id',11)->get();
    ...
    public function getSteerCommUser(){
       $input=Input::all();
      if($input['m_code']==6){
              ...
              foreach ( $data as $key) {
                ...
                $user =DB::table('tb_users')
                    ...
                    ->where('sub_department',$input['sub_dep'])
                    ->get();
             ...
             $data=DB::table('request_progress_status')
              ...
              if(!empty($data)){
                  ...
                  ->update(
                   ...
                   DB::table('approval_for_risk_assessment_for_cost_involved')
                  ->where('request_id',$input['r_id'])
                  ->where('user_id',$input['existUser'])
                  ->update(
                      array('user_id' => $input['user'],
