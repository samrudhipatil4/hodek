...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="col-md-8">
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('commonpdfMonthly/') }}{{'/'.$project_details->id;}}">PDF Download</a>
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('commonexcelMonthly/') }}{{'/'.$project_details->id;}}">Excel Download</a>
