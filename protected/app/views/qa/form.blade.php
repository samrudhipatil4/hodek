	...
	<div class="page-content-wrapper">
		...
		<div class="sbox animated fadeInRight">
			...
			<div class="sbox-content">
				...
				{{ Form::open(array('url'=>'qa/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true ,'parsley-validate novalidate'=>'')) }}
				<div class="col-md-12">
					<fieldset><legend> QA User</legend>
...
<script type='text/javascript'>
	...
	function fetch_sub_department(value)
	{
		...
		$.ajax({
			...
			cache:false,
			data: { dep_id: value },
			url:base_url+'qa/sub_department_ajax',
...
?>
		...
		cache:false,
		//data: { dep_id: value },
		url:base_url+'qa/department_ajax/<?=$id;?>',
...
?>
		...
		cache:false,
		//data: { dep_id: value },
		url:base_url+'qa/subdepartment_ajax/<?=$id;?>/<?=$row['id'];?>',
