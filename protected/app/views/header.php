...
<link rel="stylesheet" type="text/css" href="<?php echo Request::root(); ?>/protected/public/css/BOM.css">
       ...
       <?php $companyname = BaseController::getCompanyName();
        ...
        <div class="col-sm-7 menu">
          ...
          <ul id="nav" class="nav">
            ...
            <!--  <li   <?php if ($PAGE_NAME=='BOM'){?>  class="active" <?php }?>>
              <a class="" href="<?php echo Request::root().'/BOM/indexData' ?>"><i class="fa fa-eye"></i> BOM</a>
            </li> -->
            ...
            <?php if($user_id==1 || $user_id==114){ ?>
              <li   <?php if ($PAGE_NAME=='reports'){?>  class="active" <?php }?>>
              <a class="" href="<?php echo Request::root().'/checkUserStatus' ?>"><i class="fa fa-file-text"></i>Check User Status</a>
            </li>
            <?php } ?>
              </ul>
            </li>
          ...
          <li class="dropdown profile">
           ...
           <li   <?php if ($PAGE_NAME=='modifyChangeRequest'){?>  class="active" <?php }?>>
               ...
               <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                <span>Modify Change Request</span><span class="caret"></span>
                <ul class="dropdown-menu">
                <li  <?php if ($PAGE_NAME=='modifyChangeRequest'){?>  class="active" <?php }?>>
              ...
              <a class="" href="<?php echo Request::root().'/modifyChangeRequest' ?>"><i class="fa fa-cogs" ></i> Modify Change Request</a>
                 ...
                 <li   <?php if ($PAGE_NAME=='Close_CR'){?>  class="active" <?php }?>>
              <a class="" href="<?php echo Request::root().'/Close_CR' ?>"><i class="fa fa-search"></i> Permanent Close Change Request </a>
            </li>
             <li  <?php if ($PAGE_NAME=='modifyChangeRequest'){?>  class="active" <?php }?>>
              <!--<a class="" href="<?php //echo Request::root().'/scm' ?>"><i class="fa fa-cogs"></i> SCM</a>-->
              <a class="" href="<?php echo Request::root().'/shiftTask' ?>"><i class="fa fa-cogs" ></i> Shift Task</a>
            </li>
          ...
          <ul id="right-nav" class="pull-right nav">
            ...
            <li class="dropdown profile">
              ...
              <ul class="dropdown-menu">
                ...
                <?php } ?>
                <?php if(in_array(1,explode(',',Session::get('gid'))) || in_array(11,explode(',',Session::get('gid')))){?>
