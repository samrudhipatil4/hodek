...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="col-md-8">
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('commonpdf/') }}{{'/'.$project_details->id;}}">PDF Download</a>
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('commonexcel/') }}{{'/'.$project_details->id;}}">Excel Download</a>
