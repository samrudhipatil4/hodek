...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="col-md-8">
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('matpdfWeekly/') }}{{'/'.$project_details->id;}}">PDF Download</a>
     <a class="btn btn-animate flat blue pd-btn" href="{{ url('matexcelWeekly/') }}{{'/'.$project_details->id;}}">Excel Download</a>
