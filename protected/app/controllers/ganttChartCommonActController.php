...
use Carbon\Carbon;
class ganttChartCommonActController extends BaseController  {

			
	public function index()
	{
       
            return View::make('ganttChart/ganttChartCommonAct');
 ...
 public function gnattChart(){
    ...
    //return View::make('CommonActGanttChart.projectActivity',$data);
    if($input['filter'] == 'weekly'){
      return View::make('CommonActGanttChart.projectActivityWeekly',$data);
    }else if($input['filter'] == 'monthly'){
      return View::make('CommonActGanttChart.projectActivityMonthly',$data);
    }else{
      return View::make('CommonActGanttChart.projectActivity',$data);
    } 
  }
  ...
  public function getPdftest($project_id)
  {
    ...
    $pdf=PDF::loadView('CommonActGanttChart.projectActivityPdf',$data);
   ...
   public function getPdftestWeekly($project_id)
  {
    ...
    $pdf=PDF::loadView('CommonActGanttChart.projectActivityPdfWeekly',$data);
     $pdf->setPaper('a0')->setOrientation('landscape')->setWarnings(false);
     $pdf->setTimeout(600);
     // return $pdf->stream();
     // view file in browser 
  ...
  public function getPdftestMonthly($project_id)
  {
    ...
    $pdf=PDF::loadView('CommonActGanttChart.projectActivityPdfMonthly',$data);
     $pdf->setPaper('a0')->setOrientation('landscape')->setWarnings(false);
     $pdf->setTimeout(600);
     // return $pdf->stream();
     // view file in browser 
  ...
  public function excelDownload($project_id)
  {
    ...
    $output =  View::make('CommonActGanttChart.csv_download',$data);
 ...
 public function excelDownloadWeekly($project_id)
  {
   ...
   // $diff = $date2->diff($date1)->format("%a")+1;
    ...
    $output =  View::make('CommonActGanttChart.csv_downloadWeekly',$data);
  ...
  public function excelDownloadMonthly($project_id)
  {
   ...
   $diff = $date2->diff($date1)->format("%m")+1;
    ...
    $output =  View::make('CommonActGanttChart.csv_downloadMonthly',$data);
 ...
 function gnattChartPdf($project_id)
 {
    ...
    /*$pdf=PDF::loadView('pages.projectActivityPdf', compact('data'));
      ...
      return View::make('CommonActGanttChart.projectActivityPdf',$data);    
  }
